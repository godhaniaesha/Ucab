...
const D_DashboardContent = ({ hasNewRequest, currentTrip, isTripActive }) => {
  ...
  return (
    <div className="d_tab_page p-lg-4 p-2 bg-white rounded-3 shadow-sm border border-light">
      <h2 className="fs-3 fw-bold text-dark mb-lg-4 mb-md-2 mb-1"> Driver Dashboard</h2>
          ...
          <div className="row g-4">
            <div className="col-12 col-md-4">
              <div className="bg-light p-lg-4 p-2 rounded-4 shadow-sm border border-light text-center h-100 d-flex flex-column justify-content-center">
                ...
                <h4 className="fs-4 fw-bold text-dark mt-1">7</h4>
              </div>
            </div>
            <div className="col-12 col-md-4">
              <div className="bg-light p-lg-4 p-2 rounded-4 shadow-sm border border-light text-center h-100 d-flex flex-column justify-content-center">
                ...
                <h4 className="fs-4 fw-bold text-success mt-1">$185.00</h4>
              </div>
            </div>
            <div className="col-12 col-md-4">
              <div className="bg-light p-lg-4 p-2 rounded-4 shadow-sm border border-light text-center h-100 d-flex flex-column justify-content-center">
                <i className="bi bi-wallet2 fs-3 text-primary mb-2"></i>
                <p className="text-muted mb-0">Pending Payout</p>
                <h4 className="fs-4 fw-bold text-primary mt-1">$50.00</h4>
              </div>
            </div>
          </div>
        </div>
