  ...
  return (
    <>
      ...
      <div className="d_app_container container-fluid min-vh-100 d-flex align-items-center justify-content-center p-2 p-sm-4 p-lg-5" style={{ backgroundColor: "#e0f2f1" }}>
        <div className="d_main_content_wrapper w-100 bg-white rounded-4 shadow-lg d-flex flex-column flex-lg-row overflow-hidden" style={{ maxWidth: "1200px", minHeight: "600px" }}>
